...
public class TransmissionTest {
    ...
    void shouldTransmitFromFirstToSecond() {
        ...
        Assertions.assertEquals(expectedBalanceOfFirstCardAfterTransmit, balanceOfFirstCardAfterTransmit);
        Assertions.assertEquals(expectedBalanceOfSecondCardAfterTransmit, balanceOfSecondCardAfterTransmit);
    }
